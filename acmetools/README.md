...
## C.Sh
    ...
    DESCRIPTION
    	C.Sh comments text from stdin by prepending a '#' to
...
## Ff
    ...
    DESCRIPTION
    	Ff creates a new virtual window where the user can search
    	for files dynamically in the current working directory by
...
## Fmt
    ...
    DESCRIPTION
    	Fmt formats text from stdin and prints it to stdout.
...
## Ft
    ...
    DESCRIPTION
    	Ft creates a new virtual window where the user can search
...
## Git.Diff
    ...
    DESCRIPTION
    	Git.Diff shows the git status in the current repository in a
...
## Git.Log
    ...
    DESCRIPTION
    	Git.Log shows a git log in the current repository in a
    	dedicated window called <git-repo>/+Git.
...
## Git.Status
    ...
    DESCRIPTION
    	Git.Status shows a git diff in the current repository in a
    	dedicated window called <git-repo>/+Git.
...
## I
    ...
    DESCRIPTION
    	I indents text from stdin by prepending white spaces to
    	every line; resulting output on stdout.
...
## P
    ...
    DESCRIPTION
    	P surrounds text from stdin with parentheses; resulting
    	output on stdout.
...
## Pb
    ...
    DESCRIPTION
    	Pb surrounds text from stdin with brackets; resulting
    	output on stdout.
...
## Pc
    ...
    DESCRIPTION
    	Pc surrounds text from stdin with curly braces; resulting
    	output on stdout.
...
## Proj.Ff
    ...
    DESCRIPTION
    	Proj.Ff creates a new virtual window where the user can search
...
## Proj.Ft
    ...
    DESCRIPTION
    	Proj.Ft creates a new virtual window where the user can search
    	for text dynamically in the current project by providing a
    	search string in the tagline. The search string should be
    	written between the parentheses of the Fuzzy() word.
...
## Q1
    ...
    DESCRIPTION
    	Q1 surrounds text from stdin with single quotes; resulting
    	output on stdout.
...
## Q2
    ...
    DESCRIPTION
    	Q2 surrounds text from stdin with double quotes; resulting
    	output on stdout.
...
## Read
    ...
    SYNOPSYS
    	Read [-h]
    	Read [addr|body|ctl|data|event|rdsel|tag|xdata] [-a|id|pattern]
...
## Scratch
    ...
    DESCRIPTION
    	Scratch shows a dedicated scratch window, which is useful for
...
## Tag.Common
    ...
    DESCRIPTION
    	Tag.Common loads tags in the current window's tagbar with common
...
## Tag.Dir
    ...
    DESCRIPTION
    	Tag.Dir loads tags in the current window's tagbar for working with
...
## Tag.Sh
    ...
    DESCRIPTION
    	Tag.Sh loads tags in the current window's tagbar for working with
...
## Tag.Text
    ...
    DESCRIPTION
    	Tag.Text loads tags in the current window's tagbar for working
...
## Term
    ...
    DESCRIPTION
    	Term executes the provided command or shell script in an external
...
## Uc.Sh
    ...
    DESCRIPTION
    	Uc.Sh comments text from stdin by removing a '#' from
    	every line; resulting output on stdout.
...
## Ui
    ...
    DESCRIPTION
    	Ui indents text from stdin by removing white spaces from
    	every line; resulting output on stdout.
